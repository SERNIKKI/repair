...
<div class="container-fluid">
                        ...
                        <div id="accordion" class="panel-group">
                            ...
                            <div id = "collapseThree" class="panel-collapse">
                                <div class="panel-body">
                                    ...
                                    <a class="dropdown-item active" href="assign.jsp">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file"><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path><polyline points="13 2 13 9 20 9"></polyline></svg>
                                        报修分派
                                    </a>
                    ...
                    <div id="toolbar" >
                        <form class="form-inline" style="width:100%; margin-bottom: 20px;">
                            <div class="form-group" style="margin-left: 5px;">
                                <input type="button" value="报修单分派" id="addBtn" data-toggle="modal" onclick="initModalPage()" class="btn btn-primary" >
                            </div>
                            <div class="form-group" style="margin-left: 5px;">
                                <label for="queryEquName"></label>
                                <label for="MaintainUserName"></label>
                                <input type="text" id="queryEquName" class="form-control" placeholder="设备名称">
                                <input type="text" id="MaintainUserName" class="form-control" placeholder="维修人">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <td>维修人:</td>
                            <td>
                                <input type="hidden" id="maintainID" name="maintainID">
                                <select class="form-control" id="maintainName" name="maintainName"style="width: 470px;height: 42px" >
                                    <option disabled selected>---维修人---</option>
                                </select>
                            </td>
                            </tbody>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function initModalPage(){
            //维修人
            $.ajax({
                url: "${pageContext.request.contextPath}/assign/queryMaintainName",
                method: "post",
                success: function( result ) {
                    ...
                    if(result.user_name !=null){
                        ...
                        if(user_name.length!==0){
                            $("#maintainName").empty()
                                .append("<option disabled selected>---请选择维修人---</option>");
                        }
                        for (var i = 0; i < user_name.length; i++) {
                            $("#maintainName")
                                .append(("<option value='" + user_name[i].user_name + "'>" + user_name[i].user_name + "</option>"));
                        }
        ...
        $(document).ready(function(){
            ...
            $("#maintainName").change(function(){
                var item = $("#maintainName").val();
    ...
    <script>
        ...
        function initTable(){
            ...
            $("#table").bootstrapTable({
                ...
                dataType:"json",
                url:"${pageContext.request.contextPath}/assign/list",
        ...
        function queryParam(params){
            ...
            var param={
                ...
                MaintainUserName:$("#MaintainUserName").val(),
        ...
        function addMaintenance() {
            ...
            var id=$("#id").val();
            var url='${pageContext.request.contextPath}/assign/setMaintainUser'
            $.ajax({
                url:url,
                data:{"maintainName":maintainName,"id":id},
                method:"post",
                dataType:"json",
                success:function (result) {
